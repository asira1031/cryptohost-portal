  ...
  return (
    <div style={wrap}>
      <div style={container}>
        <div style={header}>
          <div>
            <h1 style={title}>101 online-Protocol</h1>
            <p style={subtitle}>
              Secure online protocol dashboard
            </p>
          </div>

          <div style={status}>ONLINE</div>
        </div>
        ...
        <div style={grid}>
          <div style={card}>
            ...
            <Row
              label="Transaction"
              value="090512HSBC886479"
            />

            <Row
              label="Cardholder"
              value="JAGDISH ROCHINA"
            />

            <Row
              label="Card"
              value="4029 8511 0358 6660"
            />

            <Row
              label="Amount"
              value={`USD ${amount.toLocaleString()}`}
            />
          ...
          <div style={card}>
            ...
            <div style={notice}>
              Online transaction protocol initialized
            </div>
          </div>
        </div>

        <div style={card}>
          <h3>Wallet Allocation (6 Slots)</h3>
