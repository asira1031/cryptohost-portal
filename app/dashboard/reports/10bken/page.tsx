              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 max-w-3xl text-sm leading-6 text-white/60">
                    Technical report page for the uploaded Fund BARCLAYS BANK -linked
            ...
            <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
              <div className="rounded-[30px] border border-white/8 bg-[#0a1821] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.30)] sm:p-6">
                ...
                <div className="mt-5 rounded-[24px] border border-white/8 bg-[#08141c] p-4">
                  <InfoRow label="TRANSACTION CODE" value=": 4451002919GB290102819" />
                  <InfoRow label="File Name" value="10bken-BARCGB22XXX-8882910200192f" />
                  <InfoRow
                  ...
                  <InfoRow
                    label="Bank Source"
                    value="BARCLAYS BANK PLC (BARCGB22XXX)"
                  />
                  <InfoRow label="Sender" value="BLACKROCK INVESTMENT MANAGEMENT (UK) LTD" />
                  ...
                  <div className="mt-5 space-y-3">
                    <div className="rounded-2xl border border-emerald-400/20 bg-emerald-500/10 p-4">
                      ...
                      <p className="mt-1 text-sm text-emerald-100/80">
                        Document present and readable as image-based File.
                      </p>
                    </div>
            ...
            <section className="rounded-[30px] border border-white/8 bg-[#0a1821] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.30)] sm:p-6">
              ...
              {expanded ? (
                <div className="mt-5 rounded-[24px] border border-cyan-400/15 bg-[#06131b] p-4">
                  ...
                  <TerminalLine>REFERENCE: : BARCLAYS BANK PLC</TerminalLine>
                  <TerminalLine>FILE: BARCLAYS BANK PLC (BARCGB22XXX)</TerminalLine>
                  <TerminalLine>TYPE: MT103 / FINANCIAL TRANSMISSION</TerminalLine>
                  <TerminalLine>
                    BANK SOURCE: BARCLAYS BANK (BARCGB22XXX)
                  </TerminalLine>
                  <TerminalLine>SENDER: : BLACKROCK INVESTMENT MANAGEMENT (UK) LTD</TerminalLine>
